...
namespace TrashCollector.Controllers
{
    public class CustomersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CustomerId,Name,Address,CustomerZip,DayOfWeek,ApplicationUserId,BillAmount, CustomPickUp, PickupCompleted")] Customer customer)
        {
            if (ModelState.IsValid)
            {
